...
public class Program
{
    ...
    private const string blobServiceEndpoint = "https://mediastorsri.blob.core.windows.net/";
    //Update the storageAccountName value that you recorded previously in this lab.
    private const string storageAccountName = "mediastorsri";
    //Update the storageAccountKey value that you recorded previously in this lab.
    private const string storageAccountKey = "72LWvKMmgZpKlQemVeO/FXXW1QZs7G7ECt1x7s7VEkhohKPDDBpJeaEjKoQs0hUAdjJlRYSFu2O6+ASt1BjU2A==";    
